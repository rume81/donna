...
(function (factory) {
    ...
    $.widget("ui.button", {
        ...
        _create: function () {
            ...
            this.buttonElement.addClass(baseClasses)
                .attr("role", "button")
        ...
        _destroy: function () {
            ...
            this.buttonElement.removeClass(baseClasses + " ui-state-active " + typeClasses)
                .removeAttr("role")
   ...
   allowing multiple different settings on the same page. */
    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function (inst) {
            ...
            buttonPanel = (showButtonPanel) ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (isRTL ? controls : "") + (this._isInRange(inst, gotoDate) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'" +
            ...
            if (!inst.yearshtml) {
                ...
                if (secondary || !changeYear) {
                    ...
                    for (; year <= endYear; year++) {
                        inst.yearshtml += "<option value='" + year + "'" + (year === drawYear ? " selected='selected'" : "") +
                            ">" + year + "</option>";
                    }
   ...
   @return  jQuery object */
    ...
    var dialog = $.widget("ui.dialog", {
        ...
        _size: function () {
            ...
            maxContentHeight = typeof options.maxHeight === "number" ? Math.max(0, options.maxHeight - nonContentHeight) :
                "none";
...
*/
                    ...
                    set: function (elem, value) {
                        ...
                        if (value !== "transparent" && (jQuery.type(value) !== "string" || (parsed = stringParse(value)))) {
                            ...
                            if (!support.rgba && value._rgba[3] !== 1) {
                                ...
                                value = value.blend(backgroundColor && backgroundColor !== "transparent" ? backgroundColor :
                                    "_default");
                            }
        ...
        _renderMenu: function (ul, items) {
            ...
            $.each(items, function (index, item) {
                if (item.optgroup !== currentOptgroup) {
                    $("<li>", {
                        "class": "ui-selectmenu-optgroup ui-menu-divider" + (item.element.parent("optgroup").prop("disabled") ?
                            " ui-state-disabled" :
                            ""),
                        text: item.optgroup
                    })
    ...
    var spinner = $.widget("ui.spinner", {
        ...
        _draw: function () {
            var uiSpinner = this.uiSpinner = this.element.addClass("ui-spinner-input")
                .attr("autocomplete", "off")
    ...
    var tabs = $.widget("ui.tabs", {
        ...
        _refresh: function () {
            ...
            if (!this.active.length) {
                ...
                this.active.addClass("ui-tabs-active ui-state-active")
                    .attr({
                    "aria-selected": "true",
                    "aria-expanded": "true",
                    tabIndex: 0
