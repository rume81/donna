...
$(".next").click(function () {
	var pgval = $('#pagenum').val();
	
	if(($('#fname').val()=='') && (pgval=='1')){
		showMsg("Fast Name required","Error");
		return;
	}
	
	if(($('#fdname').val()=='') && (pgval=='1')){
		showMsg("Fast Name Japanese required","Error");
		return;
	}
	
	if(($('#lname').val()=='') && (pgval=='1')){
		showMsg("Last Name required","Error");
		return;
	}
	
	if(($('#ldname').val()=='') && (pgval=='1')){
