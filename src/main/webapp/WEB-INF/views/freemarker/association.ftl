...
<div class="col-sm-10 col no-padding">
	<div class="col-md-6">
        	<h3><right>Association Panel</right></h3>
        </div>
	<div class="col-xs-6 text-right association-button no-padding">
		<form name="insert_association" id="insert_association" action="${rc.contextPath}/editassociation" method="post">
				...
				<input type="hidden" name="supplyid" id="selRowSup" value=""/>
	         	<button type="button" class="btn btn-default" onclick="insertAssociation('${rc.contextPath}')">Association</button>
         </form>
    </div>
	<div class="col-sm-6 col-xs-12 association-demand">				
		<table id="memberList" class="display table table-bordered" cellspacing="0" width="100%">
		    ...
		    <#assign ro=0>
		    <#list demand as dem>
		        <tr id="${dem.did}" <#if dem.sid?? && dem.sid!="">class="association"</#if>>
		            <td>${dem.did}
	...
	<div class="col-sm-6 col-xs-12 association-supply">
		<table id="supplyList" class="display table table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
            	<#assign ro1=0>
				<#list sup as sp>
                <tr id="${sp.sid}" <#if sp.did?? && sp.did!="">class="association"</#if>>
                    <td>${sp.sid!''}</td>
		...
		<div class="col-xs-12 association-color-main">
        	
        	<p> <div class="associted-color"></div> Already Associated </p>
        </div>
</div>
